...
/// Sets up and generates a new Authority by creating a secret authority key (sak).
...
/// It consists of a PyBdabeSecretUserKey and a PyBdabePublicUserKey as well as
/// an empty vector of PyBdabeSecretAttributeKeys.
///
/// # Arguments
///
///	* `pk` - A PyBdabePublicKey (PK), generated by setup()
...
/// Generates a new PyBdabePublicAttributeKey for a requested attribute, if it is handled by the authority _ska.
///
/// # Arguments
///
///	* `_pk` - A PyBdabePublicKey (PK), generated by setup()
///	* `_ska` - A PyBdabeSecretAuthorityKey (sak), associated with an authority and generated by authgen()
...
/// Generates a new PyBdabeSecretAttributeKey for a requested attribute, if it is handled by the authority _ska and user _pk_u is eligible to recieve it.
///
/// # Arguments
///
///	* `_pku` - A PyBdabePublicUserKey (PK), generated by keygen()
///	* `_ska` - A PyBdabeSecretAuthorityKey (SKauth), associated with an authority and generated by authgen()
///	* `_attribute` - The attribute value as String
#[pyfunction]
...
/// The encrypt algorithm of BDABE. Generates an PyBdabeCiphertext using an PyBdabePublicKey,
...
///	* `attr_pak` - A Vector of all PyBdabePublicAttributeKeys that are involded in the policy
...
/// The decrypt algorithm of BDABE. Reconstructs the original plaintext data as Vec<u8>, given a PyBdabeCiphertext with a matching PyBdabeUserKey.
///
/// # Arguments
///
///	* `pk` - A PyBdabePublicKey (pk), generated by the function setup()
///	* `sk` - A PyBdabeUserKey (uk), generated by the function keygen()
///	* `ct` - A PyBdabeCiphertext Ciphertext
#[pyfunction]
pub fn decrypt(
    pk: &PyBdabePublicKey,
    uk: &PyBdabeUserKey,
